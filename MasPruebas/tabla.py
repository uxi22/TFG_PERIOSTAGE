...
from PySide6.QtWidgets import (
    ...
    QMainWindow,
    QVBoxLayout,
    QWidget, QHBoxLayout, QSpacerItem, QLineEdit, QPushButton, QPointList, QGridLayout
)
...
class Dientes(QWidget):
    ...
    def paintEvent(self, event):
        ...
        for i, diente in enumerate(self.imagen.dientes1):
            ...
            self.points.append(QPoint(dist + wdiente // 2, altura))  # punto medio del diente
            dist += wdiente
        ...
        for i, diente in enumerate(self.imagen.dientes2):
            ...
            self.points.append(QPoint(dist + wdiente // 2, altura))
            dist += wdiente
            self.points.append(QPoint(dist, altura))
            dist += arriba2[i][1]
