...
class TratPrevio(QFrame):
    def __init__(self, parent, w):
        ...
        self.frameSubpregunta = RecuadroPreguntaRadio(self, [0, 40, w, 40], "", ["Básico", "Quirúrgico", "Ambas"], 10,
                                                      14)
